...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheTicketsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheTicketsListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheTicketsListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheTicketsListGenerated.onTable(defaultTableId).iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheTicketsListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheTicketsListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheTicketsListGenerated.onTable(defaultTableId).iPressRow(0);
            Then.onTheTicketsObjectPageGenerated.iSeeThisPage();
        });
